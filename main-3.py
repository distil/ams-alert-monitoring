...
# MAIN LOOP 
# Test without while loop, has to run as a cron job
# ------------------
if __name__ == '__main__':
    try:
        ...
        print_to_terminal_and_log(f'Data from Google Sheet retrieved at {time.asctimINme(datetime.utcnow().timetuple())}', 'green')
        write_memory_log()
        ...
        print_to_terminal_and_log(f'Error {exc}', 'red')

/home/ubuntu/ams-alert-monitoring